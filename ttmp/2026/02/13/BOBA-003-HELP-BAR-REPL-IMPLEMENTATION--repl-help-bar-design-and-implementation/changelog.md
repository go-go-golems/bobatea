...
Implemented tasks 22-27: help drawer docking (default above-repl), right-edge clamping, pin/freeze behavior, configurable pin shortcut, and anti-flicker refresh rendering; validated with focused pkg/repl test+lint and full pre-commit checks. (commit 2fbf225)

### Related Files

- /home/manuel/workspaces/2026-02-13/integrate-ast-parser-repl/bobatea/pkg/repl/config.go — Added HelpDrawer dock/pin/margin config surface and defaults
- /home/manuel/workspaces/2026-02-13/integrate-ast-parser-repl/bobatea/pkg/repl/help_drawer_model_test.go — Added tests for docking
